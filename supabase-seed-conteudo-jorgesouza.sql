-- ATENÇÃO: Substitua 'SEU-CLIENT-ID-AQUI' pelo ID real do cliente Jorge Souza
-- Para encontrar: SELECT id FROM clients WHERE name ILIKE '%jorge%';

DO $$
DECLARE
  cid uuid := 'SEU-CLIENT-ID-AQUI';
BEGIN

-- DIA 1 - MANHÃ
INSERT INTO conteudo_posts (client_id, dia, semana, horario, formato, categoria, titulo, roteiro, direcao, cta_legenda) VALUES
(cid, 1, 1, 'manha', 'reel', 'estalo', 'Você não vende pouco porque não tem seguidores',
...
-- DIA 1 - NOITE
INSERT INTO conteudo_posts (client_id, dia, semana, horario, formato, categoria, titulo, roteiro, direcao, cta_legenda) VALUES
(cid, 1, 1, 'noite', 'reel', 'tutorial', 'Como habilitar sua loja no TikTok Shop do zero em 2025',
...
(cid, 2, 1, 'manha', 'reel', 'narrativa', 'Por que o Mercado Livre deveria estar preocupado com o TikTok Shop',
...
(cid, 2, 1, 'noite', 'carrossel', 'tutorial', 'Os 5 erros que travam vendedores nos primeiros 30 dias no TikTok Shop',
...
(cid, 3, 1, 'manha', 'reel', 'reacao', 'Shopee anuncia expansão logística no Brasil — o que isso revela para vendedores do TikTok Shop',
...
-- DIA 3 - NOITE
INSERT INTO conteudo_posts (client_id, dia, semana, horario, formato, categoria, titulo, roteiro, cta_legenda) VALUES
(cid, 3, 1, 'noite', 'reel', 'tutorial', 'Como funcionam as taxas do TikTok Shop — número real na tela',
...
-- DIA 4 - MANHÃ
INSERT INTO conteudo_posts (client_id, dia, semana, horario, formato, categoria, titulo, roteiro, cta_legenda) VALUES
(cid, 4, 1, 'manha', 'reel', 'estalo', 'Quem vende produto vende uma vez. Quem cria audiência vende para sempre.',
...
-- DIA 4 - NOITE
INSERT INTO conteudo_posts (client_id, dia, semana, horario, formato, categoria, titulo, roteiro, cta_legenda) VALUES
(cid, 4, 1, 'noite', 'reel', 'caso', 'Aluna que entrou no Club sem saber nada — o que aconteceu em 30 dias',
...
-- DIA 5 - MANHÃ
INSERT INTO conteudo_posts (client_id, dia, semana, horario, formato, categoria, titulo, roteiro, cta_legenda, dados_apoio) VALUES
(cid, 5, 1, 'manha', 'reel', 'previsao', 'O que vai mudar no TikTok Shop nos próximos 90 dias — visão de Embaixador',
...
-- DIA 5 - NOITE
INSERT INTO conteudo_posts (client_id, dia, semana, horario, formato, categoria, titulo, roteiro, cta_legenda) VALUES
(cid, 5, 1, 'noite', 'carrossel', 'tutorial', 'As 3 fases de todo vendedor bem-sucedido no TikTok Shop',
...
-- DIA 6 - MANHÃ
INSERT INTO conteudo_posts (client_id, dia, semana, horario, formato, categoria, titulo, roteiro, cta_legenda) VALUES
(cid, 6, 1, 'manha', 'reel', 'bastidor', 'Bastidor: como é uma reunião de Embaixador com o time do TikTok Shop Brasil',
...
-- DIA 6 - NOITE
INSERT INTO conteudo_posts (client_id, dia, semana, horario, formato, categoria, titulo, roteiro, cta_legenda) VALUES
(cid, 6, 1, 'noite', 'reel', 'caso', 'Quanto ganhou esse afiliado no primeiro mês — sem ter estoque',
...
-- DIA 7 - MANHÃ
INSERT INTO conteudo_posts (client_id, dia, semana, horario, formato, categoria, titulo, roteiro, cta_legenda) VALUES
(cid, 7, 1, 'manha', 'reel', 'estalo', 'O maior erro de quem começa no TikTok Shop não é técnico',
...
-- DIA 7 - NOITE
INSERT INTO conteudo_posts (client_id, dia, semana, horario, formato, categoria, titulo, roteiro, cta_legenda) VALUES
(cid, 7, 1, 'noite', 'carrossel', 'narrativa', 'Recap semana 1: 3 movimentos de mercado que a maioria ignorou',
