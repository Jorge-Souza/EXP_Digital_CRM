...
import { LayoutDashboard, GraduationCap, Package, LogOut, ChevronUp, ArrowLeft, ShoppingBag, Megaphone, ClipboardList, BookOpen, BarChart2, ShoppingCart, Kanban } from "lucide-react"
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
