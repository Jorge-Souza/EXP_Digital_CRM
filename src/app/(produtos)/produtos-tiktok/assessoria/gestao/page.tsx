...
import { Plus, GraduationCap, User, Calendar, DollarSign, Store, ArrowLeft } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <Link href="/produtos-tiktok/assessoria" className="text-xs text-muted-foreground hover:text-foreground inline-flex items-center gap-1.5 mb-1">
