...
export const metadata: Metadata = {
  title: "Aulão TikTok Shop — Jorge Souza",
  description: "Tudo o que você precisa saber para vender de verdade na plataforma — estrutura, conteúdo, tráfego e operação.",
}
...
export default function AulaoPage() {
  return (
    <div style={{ background: S.black, color: S.white, fontFamily: "Inter, sans-serif", fontSize: 16, lineHeight: 1.65, minHeight: "100vh" }}>
